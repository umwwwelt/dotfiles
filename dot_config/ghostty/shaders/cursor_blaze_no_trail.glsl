...
// const vec4 TRAIL_COLOR = vec4(0.204, 0.9, 0.85, 1.0);
// const vec4 TRAIL_COLOR_ACCENT = vec4(0.471, 1.0, 0.962, 1.0);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    newColor = mix(newColor, TRAIL_COLOR_ACCENT, 1.0 - smoothstep(cCursorDistance, -0.000, 0.002 * (1. - progress)));
    newColor = mix(newColor, CURRENT_CURSOR_COLOR, 1.0 - smoothstep(cCursorDistance, -0.000, 0.002 * (1. - progress)));
